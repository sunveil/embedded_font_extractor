...
public class ExtractEmbeddedFonts {
    ...
    private static final String OUTPUT_DIR = "/home/sunveil/Documents/projects/ispras/tmp";

    public static void main(String[] args) throws Exception{

        String filePath = "/home/sunveil/Documents/projects/ispras/JCT2021_template.pdf";
        try (final PDDocument document = Loader.loadPDF((new File(filePath)))){
